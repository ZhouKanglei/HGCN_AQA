...
class Group_helper(object):
    def __init__(self, dataset, depth, ouput_device=0, Symmetrical=True, Max=None, Min=None):
        '''
        ...
        self.output_device = ouput_device
    ...
    def produce_label(self, scores):
        ...
        glabel = torch.tensor(glabel).cuda(self.output_device)
        rlabel = torch.tensor(rlabel).cuda(self.output_device)

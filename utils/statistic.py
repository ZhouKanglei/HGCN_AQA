...
def sta_aqa7():
    ...
    for exp_path in exp_paths:
        stat_hist_aqa7(exp_path)



def stat_hist_jig(exp_path):
    print(exp_path)
    titles, rhos, rl2s = [], [], []

    for i in range(1, 4):
        for j in range(4):
            hist_path = os.path.join(exp_path, f'{i}_{j}/weights/history.npz')
            if os.path.exists(hist_path):
                history = np.load(hist_path)
                hist_test = history['test']
                rhos.append(hist_test[:, 1].max())
...
def sta_jig():
    exp_paths = ['/home/zkl/Documents/Codes/AQA/exps/JIGSAWS/ours',
                 '/home/zkl/Documents/Codes/AQA/exps/JIGSAWS/ours_decay_1e3',
                 '/home/zkl/Documents/Codes/AQA/exps/JIGSAWS/ours_view1',
                 '/home/zkl/Documents/Codes/AQA/exps/JIGSAWS/ours_view2',
                 '/home/zkl/Documents/Codes/AQA/exps/JIGSAWS/ours_hgn',
                 ]

    for exp_path in exp_paths:
        stat_hist_jig(exp_path)
